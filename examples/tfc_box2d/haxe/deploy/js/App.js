...
Main.prototype = {
	...
	,initializeBox2D: function() {
		...
		this.flashToBox2dConverter = new com.dango_itimi.toolkit_for_createjs.box2d.FlashToBox2dConverterForJS(myChunkMap);
...
tfc_box2d.MyChunkMap.prototype = $extend(com.dango_itimi.box2d.fla.ChunkMap.prototype,{
	initializeForPolygon: function() {
		this.createPolygon(0,lib.tfc_box2dpolygonFlipper,true,true,1,0,1,false);
	}
	,initializeForCircle: function() {
		this.createCircle(0,lib.tfc_box2dcircleCircleTest,false,true,1,0,1,false,-1);
		this.createCircle(1,lib.tfc_box2dcircleCircleTest2,true,true,1,0.5,1,false,-1);
	}
	,initializeForBox: function() {
		this.createBox(0,lib.tfc_box2dboxBoxBackground,false,false,0,1);
		this.createBox(1,lib.tfc_box2dboxCharacter,true,false,1,1,1,false);
	}
