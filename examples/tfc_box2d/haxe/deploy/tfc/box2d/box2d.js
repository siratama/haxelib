...
(lib.box = function() {
	...
	this.shape_2.graphics.f("#3399FF").s().p("AAKgJIAAATIgTAAIAAgTIATAA").cp();
...
(lib.tfc_box2dcircleCircleTest2 = function() {
	this.initialize();
	...
	// レイヤー 1
	this.c0 = new lib.circle();
	this.c0.setTransform(333,184,1.835,1.835);

	this.c2 = new lib.circle();
	this.c2.setTransform(219,184,1.835,1.835);

	this.c1 = new lib.circle();
	this.c1.setTransform(94,239,1.835,1.835);

	this.addChild(this.c1,this.c2,this.c0,this.instance_2,this.instance_1,this.instance);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(66.4,26.8,334.8,306.4);


(lib.tfc_box2dcircleCircleTest = function() {
	this.initialize();
	...
	this.c0_1.setTransform(88,122,1.835,1.835);

	this.c2_1 = new lib.circle();
	this.c2_1.setTransform(88,80,1.835,1.835);

	this.c1_1 = new lib.circle();
	this.c1_1.setTransform(50,103,1.835,1.835);

	this.addChild(this.c1_1,this.c2_1,this.c0_1,this.instance_5,this.instance_4,this.instance_3);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(40.8,70.8,224.4,238.4);


(lib.tfc_box2dboxCharacter = function() {
	this.initialize();

	// レイヤー 1
	this.c0_2 = new lib.box();
	this.c0_2.setTransform(199,106.1,26,26);

	this.addChild(this.c0_2);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(173,80.1,52,52);


(lib.tfc_box2dboxBoxBackground = function() {
	this.initialize();
	...
	this.c1_2 = new lib.box();
	this.c1_2.setTransform(591,143.4,5,355.953);
	this.c1_2.alpha = 0.398;

	this.c2_2 = new lib.box();
	this.c2_2.setTransform(287.1,436,386.045,4.995);
	this.c2_2.alpha = 0.398;

	this.addChild(this.c2_2,this.c1_2,this.c3,this.instance_8,this.instance_7,this.instance_6);
}).prototype = p = new cjs.Container();
...
(lib.tfc_box2dpolygonFlipper = function() {
	this.initialize();

	// レイヤー 1
	this.c1_3 = new lib._1();
	this.c1_3.setTransform(370,310.1);

	this.c0_3 = new lib._0();
	this.c0_3.setTransform(268,357);

	this.addChild(this.c0_3,this.c1_3);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(262,308.1,191,88.9);


(lib.tfc_box2dChunkMapContainer = function() {
	this.initialize();

	// flipper
	this.flipper = new lib.tfc_box2dpolygonFlipper();

	// circleTest2
	this.circleTest2 = new lib.tfc_box2dcircleCircleTest2();

	// circleTest
	this.circleTest = new lib.tfc_box2dcircleCircleTest();

	// char
	this.character = new lib.tfc_box2dboxCharacter();

	// background
	this.boxBackground = new lib.tfc_box2dboxBoxBackground();
